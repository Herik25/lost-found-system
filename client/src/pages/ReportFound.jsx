...
function ReportFound() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.locationFound) newErrors.locationFound = true;
    ...
    try {
      ...
      toast.success("Found item successfully reported!");
      setSuccess(true);
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
        ...
        <p className="text-slate-500 text-lg">
          Thank you for being a hero! Redirecting to dashboard...
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-3xl font-bold text-slate-900">Report Found Item</h1>
      </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="glass-card p-8 rounded-4xl space-y-6">
            <div>
              ...
              <input
                name="title"
                placeholder="Ex: Keys with a Red Keychain"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2 ml-1">
                  <MapPin size={16} className="text-primary" /> Location Found
                </label>
                <input
                  name="locationFound"
                  placeholder="Ex: Main Gate Security"
                  onChange={handleChange}
                  className={`input-field mb-0 ${errors.locationFound ? "border-red-500 bg-red-50 focus:border-red-500 focus:ring-0" : ""}`}
                />
              </div>
            </div>
            ...
            <div>
              <label className="flex items-center gap-2 text-sm font-bold text-slate-700 mb-2 ml-1">
                <Archive size={16} className="text-primary" /> Storage Location
                (Optional)
              </label>
              <input
                name="storageLocation"
                placeholder="Where is the item kept now? (Ex: Reception desk)"
                onChange={handleChange}
            ...
            <div>
              ...
              <textarea
                name="description"
                placeholder="Be descriptive but don't give away secret identifying marks (let the owner prove it)..."
                rows={4}
                onChange={handleChange}
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="glass-card p-8 rounded-4xl h-full flex flex-col">
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full mt-8 flex items-center justify-center gap-2 h-14 shadow-secondary/20"
            >
              {loading ? (
